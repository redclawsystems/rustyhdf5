...
pub use rustyhdf5_format::file_writer::AttrValue;
...
pub(crate) fn classify_datatype(dt: &rustyhdf5_format::datatype::Datatype) -> DType {
...
pub(crate) fn attrs_to_map(
    attrs: &[rustyhdf5_format::attribute::AttributeMessage],
    file_data: &[u8],
    offset_size: u8,
    length_size: u8,
...
fn decode_attr_value(
    attr: &rustyhdf5_format::attribute::AttributeMessage,
    file_data: &[u8],
    offset_size: u8,
    length_size: u8,
) -> Option<AttrValue> {
